...
//	}
	...
	CommandLineRunner run(UserService userService) {
		return args -> {
			...
			userService.saveUser(new User(null, "Kaisei", "Ota", "kaiseiota", "kota", new ArrayList<>(), new ArrayList<>()));
			userService.saveUser(new User(null, "Kawada", "Masahiro", "kawadamasahiro", "kmasahiro", new ArrayList<>(), new ArrayList<>()));
			userService.saveUser(new User(null, "David", "Choi", "davidchoi", "dchoi", new ArrayList<>(), new ArrayList<>()));
